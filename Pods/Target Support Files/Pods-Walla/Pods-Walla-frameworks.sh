...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/FirebaseRxSwiftExtensions/FirebaseRxSwiftExtensions.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Lock-Facebook/LockFacebook.framework"
